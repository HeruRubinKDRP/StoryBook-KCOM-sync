  ...
  return (
    <div className={`smart-family ${getContainerQuery(width)} page-container`} ref={ref}>
      ...
      <Kcarousel
        ...
        slides={[
          <div key="0" className="images-container logos">
            <img alt="" className="image-item" src="/logos/the_spoon_logo.svg"/>
            <img alt="" className="image-item" src="/logos/cnn_underscored_logo.svg"/>
            <img alt="" className="image-item" src="/logos/tiktok_logo.svg"/>
            <img alt="" className="image-item" src="/logos/Men_s_Health_logo.svg"/>
            <img alt="" className="image-item" src="/logos/logo_apartment_therapy.svg"/>
            <img alt="" className="image-item" src="/logos/logo_USA_today.svg"/>
          </div>
        ]}
      ...
      <ContentItem
        ...
        sectionName=""
      />
      {/*<div className="deco-wavy">*/}
      {/*  <img src="/deco/wavy.svg" />*/}
      {/*</div>*/}
      <ContentItem
        backGroundType="solid-color"
        backgroundColor="white"
      ...
      {/*  ctaMode="button"*/}
      {/*  heightMethod="fit-content"*/}
      {/*  mainMessage="What’s most important to you in a SMART coffee maker? "*/}
      {/*  mainMessageColor="#3B2B2F"*/}
      {/*  mainMessageSize="Large"*/}
      {/*  messageTextAlignment="text-center"*/}
      {/*  secondaryMessage=""*/}
