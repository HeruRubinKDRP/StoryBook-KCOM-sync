...
// specifications area
// ******** kcs
export const KCS_specs_data : getElementType[]  = [
   {
     cardData: {
...
export const KCS_images : any[] = [
  <div key="0" className="image-item-container"><img alt="" className="image-item" src="/product-images/kcs/kcs-0.png" title=""/></div>,
