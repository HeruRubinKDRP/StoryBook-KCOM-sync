...
const Template: Story<iCombineComponent> = (args) => {
    const headerRef = React.createRef<HTMLDivElement>();
    return <CombinedComponent {...args} headerRef={headerRef}/>;
}

export const CombineExample = Template.bind({})
CombineExample.args = {
    stickyHeaderMode: "slim",
    stickyHeader: {
        stickyHeaderMode: "slim",
        headerRef: null, // add headerRef property
        navigationRelated: {
...
export const CombineExampleSilhouette = Template.bind({})
CombineExampleSilhouette.args = {
    stickyHeaderMode: "slim",
    stickyHeader: {
        stickyHeaderMode: "slim",
        headerRef: null, // add headerRef property
