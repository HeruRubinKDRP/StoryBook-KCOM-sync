...
4a. "sequenceType": if response has instructions involving stirring, heating, or pouring, set sequenceType to "recipe"; other instructions set to "instructions", otherwise set as "none". 
4b. "prerequisite": anything the user will need before starting. 
4c. "steps": field to an array of steps the user should take. Always incorporate Keurig products rather than generic, like "Dark Roast K-Cup" rather than "dark roast coffee".  
